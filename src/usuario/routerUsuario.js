...
import { getUsuarios,addUser,updateUser,deleteUser,authUser,getUserRegister} from '../usuario/controllerUsuario.js';
...
routerUser.post('/getUserRegister',getUserRegister);
